...
define( ['./PacketStructure' ], function( PACKET )
{
	...
	return {
		...
		0x9e6: PACKET.ZC.ACK_TRADE_BUYING_STORE,
		...
		0x442: PACKET.ZC.SKILL_SELECT_REQUEST, // ok
		0x443: PACKET.CZ.SKILL_SELECT_RESPONSE, // ok
		...
		0x997: PACKET.ZC.EQUIPWIN_MICROSCOPE_V4,
...
*/
		...
		0x9e9: PACKET.CZ.CLOSE_RODEXBOX, // ok
		0x9ea: PACKET.CZ.REQ_READ_RODEX, // ok
		0x9eb: PACKET.ZC.ACK_READ_RODEX, // ok
		0x9ec: PACKET.CZ.REQ_SEND_RODEX, // ok
		0x9ed: PACKET.ZC.ACK_SEND_RODEX, // ok
		0x9ee: PACKET.CZ.REQ_NEXT_RODEX, // ok
		0x9ef: PACKET.CZ.REQ_REFRESH_RODEX, // ok
		0x9f0: PACKET.ZC.ACK_RODEX_LIST, // ok
		0x9f1: PACKET.CZ.REQ_ZENY_FROM_RODEX, // ok
		0x9f2: PACKET.ZC.ACK_ZENY_FROM_RODEX, // ok
		...
		0xa03: PACKET.CZ.REQ_CANCEL_WRITE_RODEX, // ok
		...
		0xa14: PACKET.ZC.CHECK_RECEIVE_CHARACTER_NAME, // ok
		...
		0xa28: PACKET.ZC.ACK_OPENSTORE2, // ok
		0xa2d: PACKET.ZC.EQUIPWIN_MICROSCOPE_V5,
		0xa30: PACKET.ZC.ACK_REQNAMEALL2, // not tested yet (Thapakorn)
		//0xa32: PACKET.ZC.OPEN_RODEX_THROUGH_NPC_ONLY
		0xa37: PACKET.ZC.ITEM_PICKUP_ACK7,
		0xa39: PACKET.CH.MAKE_CHAR3,
		0xa3b: PACKET.ZC.HAT_EFFECT,
		0xa41: PACKET.ZC.SKILL_SCALE, // ok (need to add red square on ground)
		0xa43: PACKET.ZC.ADD_MEMBER_TO_GROUP3, // ok
		0xa44: PACKET.ZC.GROUP_LIST2, // ok
		0xa4e: PACKET.ZC.RANDOM_COMBINE_ITEM_UI_OPEN,
		0xa4f: PACKET.CZ.REQ_RANDOM_COMBINE_ITEM,
		0xa50: PACKET.ZC.ACK_RANDOM_COMBINE_ITEM,
		0xa51: PACKET.ZC.CHECK_RECEIVE_CHARACTER_NAME2, // ok
		0xa68: PACKET.CZ.UI_OPEN, //ok
		0xa6e: PACKET.CZ.REQ_SEND_RODEX2, // ok
		0xa70: PACKET.CZ.RANDOM_COMBINE_ITEM_UI_CLOSE,
		0xa7d: PACKET.ZC.ACK_RODEX_LIST2, // ok
		0xa84: PACKET.ZC.GUILD_INFO3, // ok
		0xa95: PACKET.ZC.CONFIG_NOTIFY2, // ok
		0xa96: PACKET.ZC.ADD_EXCHANGE_ITEM4, // ok
		0xa97: PACKET.CZ.REQ_WEAR_SWITCHEQUIP_ADD,
		0xa98: PACKET.ZC.REQ_WEAR_SWITCHEQUIP_ADD_RESULT,
		0xa99: PACKET.CZ.REQ_WEAR_SWITCHEQUIP_REMOVE,
		0xa9a: PACKET.ZC.REQ_WEAR_SWITCHEQUIP_REMOVE_RESULT,
		0xa9b: PACKET.ZC.SEND_SWAP_EQUIPITEM_INFO,
		0xa9c: PACKET.CZ.REQ_FULLSWITCH,
		0xa9d: PACKET.ZC.REQ_FULLSWITCH_RESULT,
		0xaa0: PACKET.ZC.OPEN_REFINING_UI,
		0xaa1: PACKET.CZ.REFINING_SELECT_ITEM,
		0xaa2: PACKET.ZC.REFINING_MATERIAL_LIST,
		0xaa3: PACKET.CZ.REQ_REFINING,
		0x0225: PACKET.CZ.REQ_REFINING,
		0x097d: PACKET.ZC.BROADCAST_ITEMREFINING_RESULT,
		0x0aa0: PACKET.ZC.OPEN_REFINING_UI,
		0x0aa1: PACKET.CZ.REFINING_SELECT_ITEM,
		0x0aa2: PACKET.ZC.REFINING_MATERIAL_LIST,
		0x0aa3: PACKET.CZ.REQ_REFINING,
		0x0aa4: PACKET.CZ.CLOSE_REFINING_UI,
		
		0xaa4: PACKET.CZ.CLOSE_REFINING_UI,
		0xaa5: PACKET.ZC.MEMBERMGR_INFO2, //
		0xaa8: PACKET.ZC.CONFIG_NOTIFY3, // ok
		0xab2: PACKET.ZC.GROUP_ISALIVE,
		0xab4: PACKET.ZC.RANDOM_UPGRADE_ITEM_UI_OPEN,
		0xab5: PACKET.CZ.RANDOM_UPGRADE_ITEM_UI_CLOSE,
		0xab6: PACKET.CZ.REQ_RANDOM_UPGRADE_ITEM,
		0xab7: PACKET.ZC.ACK_RANDOM_UPGRADE_ITEM,
		...
		0xada: PACKET.ZC.BROADCAST_ITEMREFINING_RESULT,
		0xadc: PACKET.ZC.CONFIG_NOTIFY4, // ok
		...
		0xb14: PACKET.CZ.REQ_OPEN_MSGBOX_EXTEND_BODYITEM_SIZE,
		0xb15: PACKET.ZC.ACK_OPEN_MSGBOX_EXTEND_BODYITEM_SIZE,
		0xb16: PACKET.CZ.REQ_EXTEND_BODYITEM_SIZE,
		0xb17: PACKET.ZC.ACK_EXTEND_BODYITEM_SIZE,
		0xb18: PACKET.ZC.EXTEND_BODYITEM_SIZE,
		0xb19: PACKET.CZ.CLOSE_MSGBOX_EXTEND_BODYITEM_SIZE,
		0xb1b: PACKET.ZC.NOTIFY_ACTORINIT2,
		0xb1c: PACKET.CZ.PING_LIVE,
		0xb1d: PACKET.ZC.PING_LIVE,
		0xb20: PACKET.ZC.SHORTCUT_KEY_LIST_V4,
		0xb25: PACKET.ZC.PAR_4JOB_CHANGE,
		0xb27: PACKET.ZC.GUILD_AGIT_INFO,
		0xb21: PACKET.CZ.SHORTCUT_KEY_CHANGE2,
		0xb2f: PACKET.ZC.PROPERTY_HOMUN3, // ok
		0xb37: PACKET.ZC.EQUIPWIN_MICROSCOPE_V7,
		0xb39: PACKET.ZC.SPLIT_SEND_ITEMLIST_EQUIP2,
		0xb3d: PACKET.ZC.PC_PURCHASE_ITEMLIST_FROMMC3, // ok
		0xb3f: PACKET.ZC.ACK_ADD_ITEM_RODEX2, // ok
		0xb40: PACKET.ZC.PC_PURCHASE_MYITEMLIST2,
		0xb41: PACKET.ZC.ITEM_PICKUP_ACK8,
		0xb42: PACKET.ZC.ADD_EXCHANGE_ITEM5, // ok
		0xb43: PACKET.ZC.CHANGE_ITEM_OPTION,
		...
		0xb76: PACKET.ZC.PROPERTY_HOMUN4, // ok
		0xb77: PACKET.ZC.PC_PURCHASE_ITEMLIST2,
		0xb7b: PACKET.ZC.GUILD_INFO4,
		0xb7d: PACKET.ZC.MEMBERMGR_INFO3,
		0xb6f: PACKET.HC.ACCEPT_MAKECHAR,
		0xb8d: PACKET.ZC.REPUTE_INFO,
		0xb8f: PACKET.ZC.OPEN_REFORM_UI,
		0xb90: PACKET.CZ.CLOSE_REFORM_UI,
		0xb91: PACKET.CZ.ITEM_REFORM,
		0xb92: PACKET.ZC.ITEM_REFORM_ACK,
		//0xb96: PACKET.ZC.RODEX_BLOCK_RECEIVE
		0xb97: PACKET.CZ.CHECK_RODEX_RECEIVE,
